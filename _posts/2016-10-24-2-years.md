...
- Worked as the interim CMO for startup [Olapic](http://www.olapic.com) - I really enjoyed the chance to flex my mnuscles in a broad marketing role, helping them organize their marketing efforts and launch a new product (and congrats to them they were acquired earlier this year!)
- Helped some smaller startups figure out brand positioning & content marketing.
...
- Tried to get back into bloging in a more focused way, including a failed experiment in group blogging called [#nycblogclub](http://tomcritchlow.com/2015/09/03/nycblogclub/). Despite that, I still [managed to blog more against the resistance](http://tomcritchlow.com/2016/08/09/blogging-not-blogging/).
...
- *For content companies* - I've got more to write about this but there are different blends of content companies, from traditional media companies like the [New York Times](http://www.nytimes.com) or [Complex Media](http://complex.com) (both previous clients) to startups with an editor in chief investing in content to drive inbound marketing & SEO like Fundera (also a previous client).
...
### And build a strong professsional support network
...
I've deliberately tried to refer to myself as *independent* vs *freelance*. It's a distinction that maybe doesn't matter too much but in my mind freelance means doing a fulltime job on a contract basis. It feels like employment. But independent to me means building a business that happens to only have one employee. It means trying to add value to an organization in any way I can, not just doing what I'm told.
...
And finally, likely the topic for another post, but SEO has become unbunbled. All of the activities that make up "SEO" are now fully distributed between content teams, technology teams, biz ops teams, analytics teams and more. And more to the point, SEO has been around long enough that these teams have a working knowledge of SEO to the point that considering SEO as a centralized resource is becoming an outdated concept. It's partly why I've moved far away from the SEO positioning over the last two years - I see the writing on the wall.
...
This shifting landscape is a ripe environment to help build teams and it's also a great environment to work embedded inside organizations where you can be most effective and blur the boundries between "inside" and "outside" working with external partners and bringing fresh thinking back inside.
